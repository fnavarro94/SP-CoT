...
from src.models import LocalModel, GPTNeoXTChat
...
def parse_argument():
    ...
    if args.output_composition_path is None:
        args.output_composition_path = os.path.join(args.output_dir, "all_datasets_neoxt.pkl")

    if args.output_filtered_path is None:
        args.output_filtered_path = os.path.join(args.output_dir, "pseudo_dataset_raw_neoxt.json")

    if args.output_completion_path is None:
        args.output_completion_path = os.path.join(args.output_dir, "pseudo_dataset_complete_neoxt.json")

    if args.output_yesno_path is None:
        args.output_yesno_path = os.path.join(args.output_dir, "pseudo_dataset_yesno_neoxt.json")

    if args.output_merge_path is None:
        args.output_merge_path = os.path.join(args.output_dir, "pseudo_dataset_neoxt.json")
...
if __name__ == "__main__":
    ...
    #     max_duplicate_degrees = [0, 1, 4, 2, 4, 2]
    #     filtered_datasets = {}
    ...
    #     yesno_dataset = {}
    #     model = GPTNeoXTChat("gpt-neoxt-chat")
