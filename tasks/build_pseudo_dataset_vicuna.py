...
def parse_argument():
    ...
    if args.output_composition_path is None:
        args.output_composition_path = os.path.join(args.output_dir, "all_datasets_vicuna.pkl")

    if args.output_filtered_path is None:
        args.output_filtered_path = os.path.join(args.output_dir, "pseudo_dataset_raw_vicuna.json")

    if args.output_completion_path is None:
        args.output_completion_path = os.path.join(args.output_dir, "pseudo_dataset_complete_vicuna.json")

    if args.output_yesno_path is None:
        args.output_yesno_path = os.path.join(args.output_dir, "pseudo_dataset_yesno_vicuna.json")

    if args.output_merge_path is None:
        args.output_merge_path = os.path.join(args.output_dir, "pseudo_dataset_vicuna.json")
